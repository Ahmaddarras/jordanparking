...
include "db.php";
 ...
 if(isset($_POST['submit'])){
        ...
        $name2=$_POST['name'];
        $pass2=$_POST['pass'];
    $query = "INSERT INTO users (`Username`, Password) VALUES ('$name2','$pass2')";
...
<head>
  ...
  <title>Create account-PArking Jordan</title>
  
  
  <link href="./img/download-removebg-preview.png" rel="icon">
              ...
              <div class="card mb-3"style=" border-radius: 15px;">
                ...
                <img src="./img/Jordan1.gif" alt="">
                  ...
                  <form class="row g-3 needs-validation" action="signup.php" method="post">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" href="login.php" name="submit" type="submit">Create Account</button>
                    </div>
                    <div class="col-12">
