...
include "db.php";
session_start();
// var_dump(isset($_POST['sub1']));
 if(isset($_POST['submit'])){
    
    	$name1 =($_POST['username']);
	    $pass1 = $_POST['password'];
       
      $query = "SELECT * FROM users WHERE Username='$name1' AND Password='$pass1'";
      $result = mysqli_query($conn, $query);
      if (mysqli_num_rows($result) === 1) {
              header( "Location:Parkingsys.php");
          
          }else{
             
          header("Location:login.php?>$name1  OR  $pass1 Invalid");
...
<head>
  ...
  <title>Pages-Login - Jordan Parking</title>
